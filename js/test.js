...
let view = {
  ...
  let model = {
      ...
      allPhrases:[
        ...
        questions:[
        "1)Дань, взымавшаяся в XIII веке в пользу ханов Золотой Орды, называлась ...",
        "2)Возлагаемые государством на население обязанности выполнять определенные работы и предоставлять личное имущество в распоряжение госуд.власти - это",
        "3)Сбор четвертовых денег установился при ...",
        "4)При чьем правлении был введен налог на бороды?",
        "5)От чего зависел размер подушной подати?",
        "6)В каком году был введен сбор с проезда по шоссе Санкт-Петербург - Москва?",
        "7)Сколько процентов от государственных доходов составляла подушная подать при Екатерине II?",
        "8)Чьи проекты в сфере гос.бюджета осуществлялись при правлении Александра I?",
        "9)Кто в 1823—1844 возглавлял Министерство финансов Российской империи?",
        "10)... подразделялись на мирские и земские",
        "11)Реформы С.Ю. Витте и П.А. Столыпина проводились в период правления",
        "12)Как в истории Советской России называется экономический период 1917-1922 гг.?",
        "13)Что было основной мерой перехода от военного коммунизма к политике НЭПа?",
        "14)Основные положения новой экономической политики были приняты",
        "15)21 ноября 1941 г. был введен",
        "16)В отношении кого военный налог имел фиксированную ставку?",
        "17)Закон  «О подоходном налоге с граждан СССР, иностранных граждан и лиц без гражданства» был принят в период",
        "18)К какому виду налоговой системы относится система Российской Федерации?",
        "19)Как в 1998 году назывался правоохранительный орган в сфере налогообложения?",
        "20)Какой из налогов Российской Федерации не является федеральным?"
        ],
